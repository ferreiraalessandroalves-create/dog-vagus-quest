...
export default function EmailCapture({ dogName, onSubmit }: EmailCaptureProps) {
    ...
    >
      <div className="max-w-xl w-full space-y-8">
        ...
        <div className="space-y-4 relative">
          <Input
            type="email"
            placeholder="Digite seu email para obter seu plano"
            value={email}
            onChange={(e) => {
            ...
            onFocus={() =>
              setShowSuggestions(email.length > 0 && !email.includes("@"))
            }
          ...
          <Button
            ...
            size="lg"
            className="w-full h-14 text-lg bg-accent hover:bg-accent/90 text-accent-foreground rounded-xl"
          >
            Continuar
          </Button>
        </div>
