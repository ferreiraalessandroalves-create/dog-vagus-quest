        ...
        <div className="bg-card p-6 rounded-2xl border-2 border-border">
          <div className="relative h-64">
            ...
            <div className="absolute inset-0 flex flex-col justify-between">
              {[...Array(5)].map((_, i) => <div key={i} className="border-t border-border/30" />)}
            </div>
            ...
            <svg className="absolute inset-0 w-full h-full" viewBox="0 0 400 200">
              ...
              {/* Area under curve */}
              <motion.path d="M 20 40 Q 120 35, 150 80 T 250 130 T 340 170 L 340 200 L 20 200 Z" fill="url(#areaGradient)" initial={{
              opacity: 0
            }} animate={{
              opacity: 1
            }} transition={{
              ...
              {/* Main line */}
              <motion.path d="M 20 40 Q 120 35, 150 80 T 250 130 T 340 170" stroke="url(#lineGradient)" strokeWidth="4" fill="none" strokeLinecap="round" initial={{
              pathLength: 0
            }} animate={{
              pathLength: 1
            }} transition={{
              ...
              delay: 1.5
                ...
                <rect x="5" y="-10" width="60" height="25" rx="5" fill="hsl(var(--foreground))" />
                <text x="35" y="8" textAnchor="middle" fill="hsl(var(--background))" fontSize="12" fontWeight="bold">
                  Hoje
                </text>
              </motion.g>
              ...
              delay: 2
                ...
                <rect x="280" y="145" width="120" height="30" rx="8" fill="hsl(var(--accent))" />
                <text x="340" y="165" textAnchor="middle" fill="white" fontSize="12" fontWeight="bold">
                  Após Desafio
                </text>
              </motion.g>
            </svg>
